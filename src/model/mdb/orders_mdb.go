...
type Orders struct {
	...
	Amount             decimal.Decimal `gorm:"column:amount" json:"amount"`                             //  订单金额，保留4位小数
	ActualAmount       decimal.Decimal `gorm:"column:actual_amount" json:"actual_amount"`               //  订单实际需要支付的金额，保留4位小数
